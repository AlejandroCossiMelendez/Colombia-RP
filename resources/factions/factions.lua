...
function darRopaTrabajo (player, cmd, tip)
	...
	if isPlayerInFaction(player, 1) then --IDS: 265, 266, 267, 280-288
		if tonumber(s.genero) == 2 then
			if not tip then
				outputChatBox("Tienes varios uniformes a tu disposición. Elige uno con /rtrabajo [número]", player, 0, 255, 0)
			...
			if not tip then 
				outputChatBox("Tienes varios uniformes a tu disposición. Elige uno con /rtrabajo [número]", player, 0, 255, 0)
				outputChatBox("[1] Uniforme Fuerzas Especiales", player, 255, 255, 255)
				outputChatBox("[3] Uniforme Mujer", player, 255, 255, 255)
				outputChatBox("[4] Uniforme Detective (Alto rango)", player, 255, 255, 255)
				outputChatBox("[5] Uniforme Operaciones Especiales (Alto Rango)", player, 255, 255, 255)
				outputChatBox("[6] Uniforme Generales", player, 255, 255, 255)
				return
			elseif tipo == 1 then
			...
			elseif tipo == 6 then
				...
				outputChatBox("¡Tipo incorrecto! Usa /rtrabajo para ver los tipos disponibles.", player, 255, 0, 0)
				return
			end
		end
----------------------------------------------------------------- SURA ----------------------------------------------------
	elseif isPlayerInFaction(player, 2) then -- IDS: 274 a 279
		if tonumber(s.genero) == 2 then
			if not tip then 
				...
				outputChatBox("[1] Uniforme Medico Hombre", player, 255, 255, 255)
				outputChatBox("[2] Uniforme Medico Mujer", player, 255, 255, 255)
				outputChatBox("[3] Uniforme Cirujano Hombre", player, 255, 255, 255)
				outputChatBox("[4] Uniforme Cirujano Mujer", player, 255, 255, 255)
				outputChatBox("[5] Uniforme Directivos y Lideres", player, 255, 255, 255)
				return
			elseif tipo == 1 then
...
----------------------------------------------------------------- LA 320 ----------------------------------------------------
	elseif isPlayerInFaction(player, 17) then -- IDS: 274 a 279
		if tonumber(s.genero) == 2 then
			if not tip then 
	 			outputChatBox("Tienes varios uniformes a tu disposición.", player, 0, 255, 0)
				outputChatBox("[1] Patron.", player, 255, 255, 255)
				outputChatBox("[2] Sicarios", player, 255, 255, 255)
				return
			elseif tipo == 1 then
...
----------------------------------------------------------- HUGO BOSS ---------------------------------------------------
	--[[elseif isPlayerInFaction(player, 4) then
		if tonumber(s.genero) == 2 then
			if not tip then 
	 			outputChatBox("Elige uno con /rtrabajo [número]", player, 0, 255, 0)
				outputChatBox("[1] Hombre ", player, 255, 255, 255)
				outputChatBox("[2] Mujer ", player, 255, 255, 255)
				return
			elseif tipo == 1 then
				setElementModel(player, 18)
				elseif tipo == 2 then
				setElementModel(player, 199)
			else
...
----------------------------------------------------------- AMPER ---------------------------------------------------
	--[[elseif isPlayerInFaction(player, 5) then
		if tonumber(s.genero) == 2 then
			if not tip then 
	 			outputChatBox("Elige uno con /rtrabajo [número]", player, 0, 255, 0)
				outputChatBox("[1] Hombre ", player, 255, 255, 255)
		...
		----------------------------------------------------------- COCA COLA ---------------------------------------------------
	--[[elseif isPlayerInFaction(player, 6) then
	if tonumber(s.genero) == 2 then
			if not tip then 
	 			outputChatBox("Elige uno con /rtrabajo [número]", player, 0, 255, 0)
				outputChatBox("[1] Hombre ", player, 255, 255, 255)
			...
			elseif tipo == 1 then
				...
				----------------------------------------------------------- PEPSI ---------------------------------------------------
	elseif isPlayerInFaction(player, 7) then
if tonumber(s.genero) == 2 then
			if not tip then 
	 			outputChatBox("Elige uno con /rtrabajo [número]", player, 0, 255, 0)
				outputChatBox("[1] Hombre ", player, 255, 255, 255)
			...
			elseif tipo == 1 then
				...
				return
					...
					----------------------------------------------------------- SERVIENTREGA ---------------------------------------------------
	elseif isPlayerInFaction(player, 8) then
		if tonumber(s.genero) == 2 then
			if not tip then 
	 			outputChatBox("Elige uno con /rtrabajo [número]", player, 0, 255, 0)
				outputChatBox("[1] Hombre ", player, 255, 255, 255)
			...
			elseif tipo == 1 then
				...
				return
						...
						----------------------------------------------------------- ZENU ---------------------------------------------------
	elseif isPlayerInFaction(player, 17) then
		if tonumber(s.genero) == 2 then
			if not tip then 
	 			outputChatBox("Elige uno con /rtrabajo [número]", player, 0, 255, 0)
				outputChatBox("[1] Patron ", player, 255, 255, 255)
		...
		----------------------------------------------------------- CARTEL DE MEDELLIN ---------------------------------------------------
	--[[elseif isPlayerInFaction(player, 12) then
		if tonumber(s.genero) == 2 then
			if not tip then 
	 			outputChatBox("Elige uno con /rtrabajo [número]", player, 0, 255, 0)
				outputChatBox("[1] Bandido", player, 255, 255, 255)
				outputChatBox("[2] Bandida", player, 255, 255, 255)
				return
			elseif tipo == 1 then
		...
		----------------------------------------------------------- CLAN DEL GOLFO ---------------------------------------------------
	--[[elseif isPlayerInFaction(player, 16) then
		if tonumber(s.genero) == 2 then
			if not tip then 
	 			outputChatBox("Elige uno con /rtrabajo [número]", player, 0, 255, 0)
				outputChatBox("[1] Bandido", player, 255, 255, 255)
		...
		----------------------------------------------------------- CARTEL DE CALI ---------------------------------------------------
	elseif isPlayerInFaction(player, 15) then
		if tonumber(s.genero) == 2 then
			if not tip then 
	 			outputChatBox("Elige uno con /rtrabajo [número]", player, 0, 255, 0)
				outputChatBox("[1] Bandido", player, 255, 255, 255)
...
----------------------------------------------------------- CARTEL LA TERRAZA ---------------------------------------------------
	elseif isPlayerInFaction(player, 14) then
		if tonumber(s.genero) == 2 then
			if not tip then 
	 			outputChatBox("Elige uno con /rtrabajo [número]", player, 0, 255, 0)
				outputChatBox("[1] Bandido", player, 255, 255, 255)
				...
				return
			elseif tipo == 1 then
				setElementModel(player, 19)
				elseif tipo == 2 then
				setElementModel(player, 15)
			else
				outputChatBox("¡Tipo incorrecto!", player, 255, 0, 0)
				return
			end
...
----------------------------------------------------------- FISCALIA ---------------------------------------------------
	--[[elseif isPlayerInFaction(player, 5) then
		if tonumber(s.genero) == 2 then
			if not tip then 
	 			outputChatBox("Elige uno con /rtrabajo [número]", player, 0, 255, 0)
				outputChatBox("[1] Ropa fiscal", player, 255, 255, 255)
				return
			elseif tipo == 1 then
				setElementModel(player, 281)
			else
...
----------------------------------------------------------- TRANSITO ---------------------------------------------------
	elseif isPlayerInFaction(player, 55) then
		if tonumber(s.genero) == 2 then
			if not tip then 
	 			outputChatBox("Elige uno con /rtrabajo [número]", player, 0, 255, 0)
		...
		-------------------------------------------COMPRAYVENTA-----------------------------------
	elseif isPlayerInFaction(player, 20) then
		if tonumber(s.genero) == 2 then
			if not tip then 
	 			outputChatBox("Elige uno con /rtrabajo [número]", player, 0, 255, 0)
				outputChatBox("[1] Ropa Compraventa", player, 255, 255, 255)
				return
			elseif tipo == 1 then
...
----------------------------------------------------------- CJNG ---------------------------------------------------
	--[[elseif isPlayerInFaction(player, 889) then
		if tonumber(s.genero) == 2 then
			if not tip then 
	 			outputChatBox("Elige uno con /rtrabajo [número]", player, 0, 255, 0)
...
----------------------------------------------------------- NEIVA ---------------------------------------------------
	elseif isPlayerInFaction(player, 38) then
		if tonumber(s.genero) == 2 then
			if not tip then 
	 			outputChatBox("Elige uno con /rtrabajo [número]", player, 0, 255, 0)
	...
	elseif isPlayerInFaction(player, 27) then
		if tonumber(s.genero) == 2 then
			...
			if not tip then 
				...
				outputChatBox("[3] Uniforme DEA 3", player, 255, 255, 255)
				outputChatBox("[4] Uniforme DEA 4", player, 255, 255, 255)
				outputChatBox("[5] Uniforme DEA 5", player, 255, 255, 255)
				outputChatBox("[6] Uniforme DEA SWAT", player, 255, 255, 255)
...
----------------------------------------------------------- ELN ---------------------------------------------------
	elseif isPlayerInFaction(player, 189) then
		if tonumber(s.genero) == 2 then
			if not tip then 
	 			outputChatBox("Elige uno con /rtrabajo [número]", player, 0, 255, 0)
				outputChatBox("[1] Ropa sicario", player, 255, 255, 255)
	...
	elseif isPlayerInFaction(player, 4) then
		if tonumber(s.genero) == 2 then
			if not tip then 
				...
				outputChatBox("[4] Uniforme EJC 5", player, 255, 255, 255)
				return
			elseif tipo == 1 then
				setElementModel(player, 289)
			elseif tipo == 2 then
				setElementModel(player, 287)
			elseif tipo == 3 then
...
---------------------------------------------------------------------------------------------------------------------
	elseif isPlayerInFaction(player, 3) then -- IDS: 305, 309, 268, 50
		...
		---------------------------------------------------MECAILEGAL------------------------------------------------
	elseif isPlayerInFaction(player, 25) then -- IDS: 305, 309, 268, 50
		if tonumber(s.genero) == 2 then
			setElementModel(player, 69)
		else
			if not tip then 
	 			outputChatBox("Tienes varios uniformes de trabajo a tu disposición.", player, 0, 255, 0)
				outputChatBox("[1] Uniforme Mecanico Ilegal", player, 255, 255, 255)
				outputChatBox("[2] Uniforme Mecanico Ilegal", player, 255, 255, 255)
				return
			elseif tipo == 1 then
	...
	elseif isPlayerInFaction(player, 38) then -- IDS: 88 LOS DEL SUR
		if tonumber(s.genero) == 2 then
			setElementModel(player, 175)
		else
			if not tip then 
	...
	elseif isPlayerInFaction(player, 32) then -- IDS: 305, 309, 268, 50
		if tonumber(s.genero) == 2 then
			setElementModel(player, 175)
		else
			if not tip then 
	 			outputChatBox("Tienes varios uniformes de trabajo a tu disposición.", player, 0, 255, 0)
				outputChatBox("[1] Ropa De Cali Cartel", player, 255, 255, 255)
				return
			elseif tipo == 1 then
				setElementModel(player, 19)
			else
		...
		elseif isPlayerInFaction(player, 50) then -- IDS: 305, 309, 268, 50
		if tonumber(s.genero) == 2 then
			setElementModel(player, 69)
		else
			if not tip then 
	 			outputChatBox("Tienes varios monos de trabajo a tu disposición. Elige uno con /rtrabajo [número]", player, 0, 255, 0)
	...
	elseif isPlayerInFaction(player, 50) then -- IDS: 27, 260, 16, 53, 218
		if tonumber(s.genero) == 2 then -- Mujer 53, 218
			if not tip then 
	 			outputChatBox("Tienes varios trajes a tu disposición. Elige uno con /rtrabajo [número]", player, 0, 255, 0)
...
function toggleRopaRoboBanco (player, cmd, tipo)
	if isElementInWater(player) then outputChatBox("No puedes usar este comando en el agua.", player, 255, 0, 0) return end
	local s = exports.sql:query_assoc_single("SELECT genero, color FROM characters WHERE characterID = "..exports.players:getCharacterID(player))
	if tostring(tipo) == "1" then
		if tonumber(s.genero) == 2 then
	...
	elseif tostring(tipo) == "2" then
		...
		outputChatBox("Sintaxis: /rasaltobanco 1", player, 255, 255, 255)
	end
	if tonumber(s.genero) == 1 and tonumber(s.color) == 1 then
		triggerClientEvent("onSolicitarRopaBlanco", player)
	end
end
addCommandHandler("rasaltobanco", toggleRopaRoboBanco)	
...
------------------------------------------------------HUGOBOSS-----------------------------------
function darRopaTrabajo2 (player, cmd, tip)
	if isElementInWater(player) then outputChatBox("No puedes usar este comando en el agua.", player, 255, 0, 0) return end
	local tipo = tonumber(tip)
	local s = exports.sql:query_assoc_single("SELECT genero, color FROM characters WHERE characterID = "..exports.players:getCharacterID(player))
	if isPlayerInFaction(player, 4) then
		if tonumber(s.genero) == 2 then
			if not tip then 
	 			outputChatBox("Elige uno con /rtrabajo [número]", player, 0, 255, 0)
				outputChatBox("[1] Hombre ", player, 255, 255, 255)
		...
		if tonumber(s.genero) == 2 then
			...
			elseif tipo == 1 then
				...
				return
						...
						----------------------------------------------------------- ZENU ---------------------------------------------------
	elseif isPlayerInFaction(player, 9) then
		if tonumber(s.genero) == 2 then
			if not tip then 
	 			outputChatBox("Elige uno con /rtrabajo [número]", player, 0, 255, 0)
				outputChatBox("[1] Hombre ", player, 255, 255, 255)
...
addCommandHandler("rtrabajoruta", darRopaTrabajo2)

------------------------------------------------------------------CARTEL DE MEDELLIN----------------------------------
function darRopaTrabajo3 (player, cmd, tip)
	if isElementInWater(player) then outputChatBox("No puedes usar este comando en el agua.", player, 255, 0, 0) return end
	local tipo = tonumber(tip)
	local s = exports.sql:query_assoc_single("SELECT genero, color FROM characters WHERE characterID = "..exports.players:getCharacterID(player))
	if isPlayerInFaction(player, 5) then
		if tonumber(s.genero) == 2 then
			if not tip then 
	 			outputChatBox("Elige uno con /rtrabajo [número]", player, 0, 255, 0)
				outputChatBox("[1] Bandido", player, 255, 255, 255)
...
----------------------------------------------------------- CLAN DEL GOLFO ---------------------------------------------------
	elseif isPlayerInFaction(player, 16) then
		if tonumber(s.genero) == 2 then
			if not tip then 
	 			outputChatBox("Elige uno con /rtrabajo [número]", player, 0, 255, 0)
				outputChatBox("[1] Bandido", player, 255, 255, 255)
				outputChatBox("[2] Bandido2", player, 255, 255, 255)
				return
			elseif tipo == 1 then
				setElementModel(player, 101)
				elseif tipo == 2 then
				setElementModel(player, 40)
			else
				outputChatBox("¡Tipo incorrecto!", player, 255, 0, 0)
				return
			end
		...
		----------------------------------------------------------- COSA NOSTRA ---------------------------------------------------
	elseif isPlayerInFaction(player, 19) then
		if tonumber(s.genero) == 2 then
			if not tip then 
	 			outputChatBox("Elige uno con /rtrabajoilegal [número]", player, 0, 255, 0)
				outputChatBox("[1] Boss", player, 255, 255, 255)
				outputChatBox("[2] Mafia", player, 255, 255, 255)
				outputChatBox("[3] Mafia2", player, 255, 255, 255)
				return
			elseif tipo == 1 then
		...
		----------------------------------------------------------- FAMILIA GUCCI---------------------------------------------------
	elseif isPlayerInFaction(player, 18) then
		if tonumber(s.genero) == 2 then
			if not tip then 
	 			outputChatBox("Elige uno con /rtrabajoilegal [número]", player, 0, 255, 0)
				outputChatBox("[1] Bandido", player, 255, 255, 255)
		...
		----------------------------------------------------------- CARTEL DE SINALOA---------------------------------------------------
	elseif isPlayerInFaction(player, 24) then
		if tonumber(s.genero) == 2 then
			if not tip then 
	 			outputChatBox("Elige uno con /rtrabajo [número]", player, 0, 255, 0)
				outputChatBox("[1] Bandido", player, 255, 255, 255)
	...
	elseif isPlayerInFaction(player, 11) then
		if tonumber(s.genero) == 2 then
			if not tip then 
	 			outputChatBox("Elige uno con /rtrabajo [número]", player, 0, 255, 0)
				outputChatBox("[1] ROPAILEGAL 1", player, 255, 255, 255)
				outputChatBox("[2] ROPAILEGAL 2", player, 255, 255, 255)
				return
			elseif tipo == 1 then
				setElementModel(player, 17)
				elseif tipo == 2 then
	...
	elseif isPlayerInFaction(player, 14) then
		if tonumber(s.genero) == 2 then
			if not tip then 
	 			outputChatBox("Elige uno con /rtrabajo [número]", player, 0, 255, 0)
				outputChatBox("[1] Bandido", player, 255, 255, 255)
				outputChatBox("[2] Bandido 2", player, 255, 255, 255)
				outputChatBox("[2] Bandida", player, 255, 255, 255)
				return
			elseif tipo == 1 then
				setElementModel(player, 19)
...
----------------------------------------------------------- MAFIA RUSA ---------------------------------------------------
	elseif isPlayerInFaction(player, 10) then
		if tonumber(s.genero) == 2 then
			if not tip then 
	 			outputChatBox("Elige uno con /rtrabajo [número]", player, 0, 255, 0)
				outputChatBox("[1] Ropa Organizacion", player, 255, 255, 255)
				return
			elseif tipo == 1 then
				setElementModel(player, 16)
			else
...
addCommandHandler("rtrabajoilegal", darRopaTrabajo3)

--------------------------------------EVENTO CALAMAR-------------------------------------------
function darRopaTrabajo4 (player, cmd, tip)
	if isElementInWater(player) then outputChatBox("No puedes usar este comando en el agua.", player, 255, 0, 0) return end
	local tipo = tonumber(tip)
	local s = exports.sql:query_assoc_single("SELECT genero, color FROM characters WHERE characterID = "..exports.players:getCharacterID(player))
	if isPlayerInFaction(player, 17) then
		if tonumber(s.genero) == 2 then
			if not tip then 
	 			outputChatBox("Elige uno con /reventocalamar [número]", player, 0, 255, 0)
				outputChatBox("[1] Jugador Calamar", player, 255, 255, 255)
				return
			elseif tipo == 1 then
				setElementModel(player, 73)
			else
...
addCommandHandler("reventocalamar", darRopaTrabajo4)

--------------------------------------HABICHUELAS-------------------------------------------
function darRopaTrabajo5 (player, cmd, tip)
	if isElementInWater(player) then outputChatBox("No puedes usar este comando en el agua.", player, 255, 0, 0) return end
	local tipo = tonumber(tip)
	local s = exports.sql:query_assoc_single("SELECT genero, color FROM characters WHERE characterID = "..exports.players:getCharacterID(player))
	if isPlayerInFaction(player, 21) then
		if tonumber(s.genero) == 2 then
			if not tip then 
	 			outputChatBox("Elige uno con /rhabichuelas [número]", player, 0, 255, 0)
				outputChatBox("[1] ROPA HABICHUELAS", player, 255, 255, 255)
				return
			elseif tipo == 1 then
...
addCommandHandler("rhabichuelas", darRopaTrabajo5)