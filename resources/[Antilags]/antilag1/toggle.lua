...
addCommandHandler(antiLag_settings.cmd,
	function(x)
		...
		if (antiLag_settings.status == "off") then
			...
			outputChatBox("*Anti-lag esta activado* Usa /tengolag para desactivarlo.", 0, 255, 0)
		else
			...
			outputChatBox("*Anti-lag esta desactivado* Usa /tengolag para volver a activarlo.", 0, 255, 0)
		end
	end
)
