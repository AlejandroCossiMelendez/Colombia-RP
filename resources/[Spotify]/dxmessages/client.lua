    ...
    for k,v in pairs(cache) do
        ...
        if state == "y" then
            ...
            if progress < 1 then
                ...
                dxDrawRectangle(sx - boxSize/2, y, boxSize, 30, tocolor(r,g,b,180), true)
                dxDrawImage(sx + boxSize/2 - 13, y - 1, 32, 32, "files/right.png", 0,0,0, tocolor(r,g,b,180), true)
                dxDrawImage(sx - boxSize/2 - 18, y - 1, 32, 32, "files/left.png", 0,0,0, tocolor(r,g,b,180), true)
                dxDrawText(icon, sx, y + 30/2, sx, y + 30/2, tocolor(255,255,255,220), 1, awesomeFont, "center", "center", false, false, true)
            else 
