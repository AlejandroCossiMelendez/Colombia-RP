...
--QUATRO RODAS!!!
--==CARRO==-- 
if getElementModel(v) == 429 then --ID do Veiculo que deseja setar a hand
	...
	setVehicleHandling(v, "maxVelocity", 330) --Velocidade Máxima
	setVehicleHandling(v, "engineAcceleration", 90) -- Aceleração do Veículo
	setVehicleHandling(v, "engineInertia", 6)
