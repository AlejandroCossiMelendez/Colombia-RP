...
--QUATRO RODAS!!!
--==CARRO==-- 
if getElementModel(v) == 551 then --ID do Veiculo que deseja setar a hand
	...
	setVehicleHandling(v, "tractionBias", 1.297)
	setVehicleHandling(v, "numberOfGears", 5)
	setVehicleHandling(v, "maxVelocity", 150) --Velocidade Máxima
	setVehicleHandling(v, "engineAcceleration", 20) -- Aceleração do Veículo
	setVehicleHandling(v, "engineInertia", 10)
	setVehicleHandling(v, "driveType", "awd")
	setVehicleHandling(v, "engineType", "petrol")
	setVehicleHandling(v, "brakeDeceleration", 20) --Força do freio
	...
	setVehicleHandling(v, "suspensionUpperLimit", 0.1) --Suspensão para cima
...
if getElementModel(v) == 00 then --ID do Veiculo que deseja setar a hand
	...
	setVehicleHandling(v, "maxVelocity", 390) --Velocidade Máxima
	setVehicleHandling(v, "engineAcceleration", 90) -- Aceleração do Veículo
	setVehicleHandling(v, "engineInertia", 5.0)
	setVehicleHandling(v, "engineType", "petrol")
	setVehicleHandling(v, "brakeDeceleration", 70) --Força do freio
