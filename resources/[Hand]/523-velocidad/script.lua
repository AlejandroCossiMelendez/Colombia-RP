...
if getElementModel(v) == 00 then --ID do Veiculo que deseja setar a hand
	...
	setVehicleHandling(v, "maxVelocity", 290) --Velocidade Máxima
	setVehicleHandling(v, "engineAcceleration", 75) -- Aceleração do Veículo
	...
	--==MOTO==-- 	
if getElementModel(v) == 523 then --ID do Veiculo que deseja setar a hand
	setVehicleHandling(v, "mass", 5999) --Massa do veículo no caso 5999
	setVehicleHandling(v, "turnMass", 5999)
	setVehicleHandling(v, "maxVelocity", 230) --Velocidade Máxima
	setVehicleHandling(v, "engineAcceleration", 55) -- Aceleração do Veículo
