...
--QUATRO RODAS!!!
--==CARRO==-- 
if getElementModel(v) == 477 then --ID do Veiculo que deseja setar a hand
	...
	setVehicleHandling(v, "maxVelocity", 325) --Velocidade Máxima
	setVehicleHandling(v, "engineAcceleration", 60) -- Aceleração do Veículo
	setVehicleHandling(v, "engineInertia", 10)
	setVehicleHandling(v, "driveType", "awd")
	setVehicleHandling(v, "engineType", "petrol")
	setVehicleHandling(v, "brakeDeceleration", 35) --Força do freio
