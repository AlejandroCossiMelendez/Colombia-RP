...
--QUATRO RODAS!!!
--==CARRO==-- 
if getElementModel(v) == 400 then --ID do Veiculo que deseja setar a hand
	setVehicleHandling(v, "mass", 2000) --Massa do veículo no caso 1600
	...
	setVehicleHandling(v, "engineAcceleration", 23) -- Aceleração do Veículo
