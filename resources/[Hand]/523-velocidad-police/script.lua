...
if getElementModel(v) == 00 then --ID do Veiculo que deseja setar a hand
	...
	setVehicleHandling(v, "maxVelocity", 260) --Velocidade Máxima
	setVehicleHandling(v, "engineAcceleration", 40) -- Aceleração do Veículo
	...
	if getElementModel(v) == 523 then --ID do Veiculo que deseja setar a hand
		...
		setVehicleHandling(v, "engineType", "petrol")
		setVehicleHandling(v, "brakeDeceleration", 80) --Força do freio
