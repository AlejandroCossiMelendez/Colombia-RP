...
--QUATRO RODAS!!!
--==CARRO==-- 
if getElementModel(v) == 492 then --ID do Veiculo que deseja setar a hand
	...
	setVehicleHandling(v, "maxVelocity", 340) --Velocidade Máxima
	setVehicleHandling(v, "engineAcceleration", 35) -- Aceleração do Veículo
	setVehicleHandling(v, "engineInertia", 10)
	setVehicleHandling(v, "driveType", "awd")
	setVehicleHandling(v, "engineType", "petrol")
	setVehicleHandling(v, "brakeDeceleration", 90) --Força do freio
	...
	setVehicleHandling(v, "suspensionUpperLimit", 0.5) --Suspensão para cima
	setVehicleHandling(v, "suspensionLowerLimit", -0.2) -- Suspensão para baixo
