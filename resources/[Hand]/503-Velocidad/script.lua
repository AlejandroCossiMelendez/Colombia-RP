...
--QUATRO RODAS!!!
--==CARRO==-- 
if getElementModel(v) == 503 then --ID do Veiculo que deseja setar a hand
	...
	setVehicleHandling(v, "maxVelocity", 370) --Velocidade Máxima
	setVehicleHandling(v, "engineAcceleration", 130) -- Aceleração do Veículo
