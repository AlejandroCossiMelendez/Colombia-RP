function mensajePolicial(source, commandName, ...)
    ...
    if exports.factions:isPlayerInFaction(source, 20) then
        if mensajeAnuncio ~= "" and mensajeAnuncio ~= " " then
            for k, v in ipairs(getElementsByType("player")) do
                outputChatBox("#FF0000[ ILEGAL ] [#14ADFFCompton #0082C8Street#FFFFFF]#FFFFFF: "..mensajeAnuncio, v, 255, 255, 255, true)
            end
        else
...
addCommandHandler("csc", mensajePolicial)