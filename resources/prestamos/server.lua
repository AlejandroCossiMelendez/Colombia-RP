...
function pagarPrestamo (player, cmd, tipo, cantidad)
	...
	exports.logsic:addLogMessage("bugs", "El jugador " .. getPlayerName(player) .. " ha intentado bugear los préstamos #1 Cantidad cuota negativa.")
	return end
	if tienePrestamosPersonaje(player) == true then
...
function cambiarCuota (player, cmd, tipo, cantidad)
	...
	exports.logsic:addLogMessage("bugs", "El jugador " .. getPlayerName(player) .. " ha intentado bugear los préstamos #2 Cantidad superior de 1000$")
	return end
	if tienePrestamosPersonaje(player) == true then
