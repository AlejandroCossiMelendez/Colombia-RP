...
addEventHandler( getResourceName( resource ) .. ":introduce", root,
	function( )
		exports.gui:hint( "Tu trabajo: Repartidor", "Es fácil, sigue la ruta y párate en los puntos verdes.", 1 )
		
		if not blip and not sphere then
			sphere = createColSphere( 1362.4990234375, 256.1845703125, 19.566932678223, 50 )
			...
			addEventHandler( "onClientColShapeHit", sphere,
				function( element )
					if element == getLocalPlayer( ) then
						...
						exports.gui:hint( "Tu trabajo: Repartidor", "Sube a una camioneta." )
					end
				end
			)
		end
