...
function updateCharacters( characters )
	-- No actualizar si estamos en proceso de spawn directo
	if getElementData(getLocalPlayer(), "direct_spawn_process") then
		return
	end
		...
		table.insert( windows.characters.panes,
			{
				...
				onHover = function( cursor, pos )
						...
						dxDrawRectangle( pos[1], pos[2], pos[3] - pos[1], pos[4] - pos[2], tocolor( unpack( color ) ), postGUI )
					end,
