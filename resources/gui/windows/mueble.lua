		...
		table.insert( windows.armario_coger[2].panes,
			{
				...
				dxDrawText( "Nombre: "..tostring(nombre[k]), pos[1] + 200, pos[2]-15 , pos[1] + width, pos[2] - height, tocolor( 255, 255, 255, 255 ), 1, "default-bold", "center", "center", false, false, true, postGUI )
				end,
