	...
	function( )
		if start and duration then
			...
			if tick > start + duration then
				...
				dxDrawText( title, x + 65, y, x + width, y + 18, tocolor( 255, 255, 255, 255 * alpha ), 0.6, "bankgothic", "left", "top", true, false, true, postGUI )
				dxDrawText( text, x + 70, y + 18, x + width, y + height, tocolor( 255, 255, 255, 255 * alpha ), 1, "default", "left", "top", true, true, true, postGUI )
			end
		end
	end
)
