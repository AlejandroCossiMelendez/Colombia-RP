...
-- OPTIMIZACIÃ“N: Cache de elementos precalculados
local cache = {
...
-- OPTIMIZACIÃ“N: Actualizar cache solo cuando cambia el estado
...
-- OPTIMIZACIÃ“N: FunciÃ³n de dibujo simplificada (solo 2 draws en lugar de 6)
...
-- OPTIMIZACIÃ“N: Renderizado ultra eficiente
...
-- OPTIMIZACIÃ“N: Detectar cambios de resoluciÃ³n
addEventHandler("onClientRender", root, function()
...
addEventHandler("onClientResourceStart", resourceRoot, function()
    ...
    -- Reintento despuÃ©s de 2 segundos
    setTimer(function()
        triggerServerEvent("ak47:solicitarEstado", localPlayer)
    end, 2000, 1)
end)
