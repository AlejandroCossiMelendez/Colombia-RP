...
local TEST_WEBHOOK_URL = "https://discord.com/api/webhooks/1258670585219780661/nYHPbIyIfMhK2LlD-lqxtRotQ-OU7YWawl_RTma9yNE3OeuxF_FUGg6suhs_LB0NDSvi"
...
local function webHookExamples(thePlayer, cmd, id)
    ...
    if (isGuestAccount(account) or not isObjectInACLGroup("user."..getAccountName(account), aclGetGroup("Console"))) then
