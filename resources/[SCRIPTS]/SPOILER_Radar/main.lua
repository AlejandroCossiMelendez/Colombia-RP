...
function replaceTexture(textureName, imgPath)
	local textureReplaceShader = dxCreateShader("shader/shader.fx", 0, 0, false, "world")
...
function replaceRadarTextures()
    for i, textureName in ipairs(blipTextureNames) do
    	replaceTexture(textureName, "img/radar/blips/")
    end

    for i, textureName in ipairs(radarTextureNames) do
    	replaceTexture(textureName, "img/radar/map/")
    end
end
...
------------------------------------------------------------
-- Real Mods MTA : https://discord.gg/Pa52w2JU6v
-- Real Mods MTA : https://discord.gg/Pa52w2JU6v
-- Real Mods MTA : https://discord.gg/Pa52w2JU6v
------------------------------------------------------------