...
function darPayday (player)
	...
	if exports.players:isLoggedIn(player) then
		...
		if exports.factions:takeFactionPresupuesto(31, 150000) then
			outputChatBox("-Sueldo del Estado: #00FF00150000 pesos", player, 255, 255, 255, true)
			darDinero(player, 150000)
			g = g + 150000
		...
		if sqlloto and sqlloto.loteria and sqlloto.loteria >= 1 then 
			if bganador == sqlloto.loteria then
				outputChatBox("-Lotería Nº "..tostring(sqlloto.loteria).." (ganador): #00FF0015 Millones de pesos", player, 255, 255, 255, true)
				darDinero(player, 15000000)
				g = g + 15000000
			else
