...
function rbCreateObj_9dA72xKqP(objectid, tempObjectPosX, tempObjectPosY, tempObjectPosZ, tempObjectPosRot)
		local slot = 0
...
addEvent( "rbCreateObj_9dA72xKqP", true )
addEventHandler( "rbCreateObj_9dA72xKqP", getRootElement(), rbCreateObj_9dA72xKqP )

function getNearbyRoadblocks(thePlayer, commandName)
	if exports.factions:isPlayerInFaction ( thePlayer, 1 ) or exports.factions:isPlayerInFaction ( thePlayer, 2 ) or exports.factions:isPlayerInFaction ( thePlayer, 4 ) or exports.factions:isPlayerInFaction ( thePlayer, 11 ) then
