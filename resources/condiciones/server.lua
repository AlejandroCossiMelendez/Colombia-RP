...
function todo(player)
	...
	outputChatBox("Has aceptado las condiciones de uso de La Capital Roleplay . ¡Disfruta del servidor!", player, 0, 255, 0)
	...
	if sql and sql.nuevo and sql.nuevo == 1 then
			outputChatBox("Bienvenido por primera vez a La Capital Roleplay.", player, 0, 255, 0)
			outputChatBox("Has recibido Dinero extra por entrar por primera vez.", player, 255, 255, 0)
			exports.players:giveMoney(player, 450)
			exports.sql:query_free("UPDATE dinero_sesiones SET cantidadLogin = 450 WHERE characterID = "..tostring(charID))
...
outputChatBox("Has rechazado las condiciones. Ve al discord para borrar tu cuenta.", player, 255, 0, 0)
