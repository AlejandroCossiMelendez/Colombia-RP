--[[
Copyright (C) 2019Medellin Roleplay
...
function showCondiciones(version, texto)
        ...
        ventana = guiCreateWindow(0.31, 0.18, 0.37, 0.70, "Condiciones del servicio. La Capital Roleplay. Versión "..tostring(version), true)
