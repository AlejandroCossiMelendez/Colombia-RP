...
function toggleLights(thePlayer, cmd, level)
	if not exports.factions:isPlayerInFaction(thePlayer, 1) and not exports.factions:isPlayerInFaction(thePlayer, 2) and not exports.factions:isPlayerInFaction(thePlayer, 10) and not exports.factions:isPlayerInFaction(thePlayer, 11) and not getElementData(thePlayer, "enc1") then return end
...
function sirenasSonoras2(player)
	if exports.factions:isPlayerInFaction(player, 1) or exports.factions:isPlayerInFaction(player, 2) or exports.factions:isPlayerInFaction(player, 10) then
