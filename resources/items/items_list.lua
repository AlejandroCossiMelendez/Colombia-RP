...
item_list =
{
	...
	{ name = "Marihuana", image = true },--18
	{ name = "Hongo Magico", image = true },--19
	{ name = "Cerveza", image = true },--20
	{ name = "Perico", image = true },--21
	{ name = "Whisky", image = true },--22
	{ name = "Meta", image = true },--23
	...
	{ name = "Hamburguesa", image = true },--75
	...
	{ name = "Pico", image = true },--84
	{ name = "Ketamina", image = true },--85
	{ name = "Cautil", image = true },--86
	{ name = "Pieza Cargador Colt", image = true },--87
	{ name = "Pieza Cargador Tec9", image = true },--88
	{ name = "Pieza Cargador Ak-47", image = true },--89
	{ name = "Carga Demolicion C4", image = true },--90
	{ name = "Portatil Hackeo", image = true },--91
	{ name = "USB Hackeo", image = true },--92
	{ name = "Pastillas", image = true },--93
	--CREACION DE COCAINA--
	{ name = "Acido Tectonico", image = true },--94
	{ name = "Filtro Industrial", image = true },--95
	{ name = "Hoja de Coca", image = true },--96
	{ name = "Soda Catalizadora", image = true },--97
	{ name = "Coca Pura Celestial", image = true },--98
	{ name = "Bolsita Vacia", image = true },--99
	{ name = "Bolsita Coca Pura Celestial", image = true },--100
	{ name = "Paquete 10 Bolsitas", image = true },--101
	{ name = "Maleta Vacia", image = true },--102
	{ name = "Vodka", image = true },--103
	{ name = "Tequila", image = true },--104
	{ name = "Regadera de Plantas", image = true },--105
	{ name = "Abono para Plantas", image = true },--106
	{ name = "", image = true },--107
	{ name = "Quimicos Basicos", image = true },--108
	{ name = "Equipo Laboratorio", image = true },--109
	{ name = "", image = true },--110
	{ name = "", image = true },--111
	{ name = "", image = true },--112
	{ name = "Bomba Improvisada (IED)", image = function() return ":items/images/90.png" end },--113
}
