...
addCommandHandler("propiedades", obtenerInteriores)
...
function utilesDeServicio(player)
	if hasObjectPermissionTo( player, "command.modchat", false ) then
		...
		outputChatBox("Médicos: "..tostring(#getJugadoresFaccion(2))..".", player, 0, 255, 0)
		...
		outputChatBox("Radio: "..tostring(#getJugadoresFaccion(4))..".", player, 0, 255, 0)
	end
end
...
addCommandHandler("policias", utilesDeServicio)
