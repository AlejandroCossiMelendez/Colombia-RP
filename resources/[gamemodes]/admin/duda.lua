dudauto = {
	{pregunta = "discord", respuesta = "La dirección de nuestro Discord: https://discord.gg/KYeAyFt"},
	{pregunta = "ts3", respuesta = "La dirección de nuestro Discord: https://discord.gg/KYeAyFt"},
	{pregunta = "ts", respuesta = "La dirección de nuestro Discord: https://discord.gg/KYeAyFt"},
	{pregunta = "teamspeak", respuesta = "La dirección de nuestro Discord: https://discord.gg/KYeAyFt"},
	...
	{pregunta = "trabajo", respuesta = "Usa /trabajos y si quieres uno mejor acude al Discord: https://discord.gg/KYeAyFt"},
}
...
function onDuty (thePlayer)
	if hasObjectPermissionTo( thePlayer, "command.acceptreport", false ) then
		...
		outputChatBox("Bienvenido, "..getPlayerName(thePlayer):gsub("_", " ")..". Actualmente hay:",thePlayer,115, 194, 251)
			if nndudas == 0 then
			...
			outputChatBox("Hasta luego "..getPlayerName(thePlayer):gsub("_", " ")..". Recuerda usar /dudas de vez en cuando.",thePlayer,115, 194, 251)
		end	
	else return end
end
