...
local function createOurPedConductor( )
	...
	pedButa = createPed( 61,  260.98828125, 10.357421875, 2.442408323288, 97.617736816406, true )
...
function desbugBot(player)
	setElementPosition(pedButa, 2336.94140625, -2065.62109375, 13.546875)
	setElementRotation(pedButa, 0,0,89.41635131835)
end
