...
function abrirVentanaAsistenciaV2()
	if ventanaAsis == false then
		...
		ventanaAsis = true
		vAsistenciaGeneral = guiCreateWindow(527/1920*x, 291/1080*y, 867/1920*x, 530/1080*y, "Panel de asistencia general - Colombia RolePlay", false)
		...
		lInicioPanel = guiCreateLabel(31/1920*x, 25/1080*y, 760/1920*x, 85/1080*y, "Bienvenid@ al panel de asistencia general de Colombia RolePlay. Desde aquí podrás ver los conceptos de rol, los comandos del servidor, reportar a jugadores, ¡y muchos trámites más!\n\nSelecciona una categoría (ej. Comandos) para obtener más información. En caso de cualquier problema, siempre puedes dirigirte a un staff vía IG mediante /staff o vía IG y web a través del CAU.", false, tabInicio)
