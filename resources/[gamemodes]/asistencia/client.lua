...
function finalizarAsistencia()
	...
	outputChatBox("¡Gracias por haber usado la Asistencia al Usuario de Vendetta Roleplay!", 0, 255, 0)
end

function regeneraVentana()
	destroyElement(vAsistencia)
	vAsistencia = guiCreateWindow(428*x/1366, 188*y/768, 583*x/1366, 456*y/768, "Asistencia al Usuario - Vendetta Roleplay", false)
...
function mostrarGUIAsistencia()
	if exports.players:isLoggedIn() then
		if ventanaAsis == false then
			...
			vAsistencia = guiCreateWindow(428*x/1366, 188*y/768, 583*x/1366, 456*y/768, "Asistencia al Usuario - Colombia", false)
			guiWindowSetSizable(vAsistencia, false)
			lInfo = guiCreateLabel(117*x/1366, 41*y/768, 346*x/1366, 38*y/768, "Bienvenid@ al sistema de Asistencia al Usuario de Vendetta. \nPor favor, selecciona en la lista el problema que tienes.", false, vAsistencia)
