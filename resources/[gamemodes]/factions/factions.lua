	...
	if characterID then
		...
		for key, value in ipairs( result ) do
			...
			if factions[ factionID ] then
				...
				setElementData(player, "factionToHUD", getFactionName(factionID))
				setElementData(player, "factionIDToFact", factionID)
...
function darRopaTrabajo (player, cmd, tip)
	...
	if isPlayerInFaction(player, 1) then --IDS: 265, 266, 267, 280-288
		if tonumber(s.genero) == 2 then
			...
			if not tip then 
				...
				outputChatBox("[5] Patrullero", player, 255, 255, 255)
				outputChatBox("[6] Alto Cargo (Chaleco) )", player, 255, 255, 255)
				outputChatBox("[7] Uniforme 3 (Alto Cargo)", player, 255, 255, 255)
				outputChatBox("[8] Uniforme Motorista", player, 255, 255, 255)
				outputChatBox("[9] Uniforme ESMAD", player, 255, 255, 255)
				outputChatBox("[10] Uniforme 4 ", player, 255, 255, 255)
				return
			elseif tipo == 1 then
	...
	elseif isPlayerInFaction(player, 7) then -- IDS: 27, 260, 16, 53, 218
		...
		elseif isPlayerInFaction(player, 6) then -- IDS: 27, 260, 16, 53, 218
			setElementModel(player, 287)
		else
			if not tip then 
	 			outputChatBox("Usar /ropatrabajo [número]", player, 0, 255, 0)
				outputChatBox("[1] Militar", player, 255, 255, 255)
				return
			elseif tipo == 1 then
				setElementModel(player, 287)
			else
