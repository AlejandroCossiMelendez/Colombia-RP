...
function drawLogin()
	...
	dxDrawText2("Colombia Roleplay",sX/2 - (405*x)/2,0,400*x,160*y,tocolor(0,0,0, math.abs(math.sin(getTickCount()/700))*255), 3*fontsize,"arial","center","bottom")
	dxDrawText2("Colombia Roleplay",sX/2 - (400*x)/2,0,400*x,160*y,tocolor(255,255,255, math.abs(math.sin(getTickCount()/700))*255), 3*fontsize,"arial","center","bottom")
