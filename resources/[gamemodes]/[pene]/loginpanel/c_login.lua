...
-- Login
  if action == 'login' then
    ...
    dxDrawImage((650 + x)/zoom, 190/zoom, 250/zoom, 250/zoom, images['puls'], 0, 0, 0, tocolor(72, 0, 191, a), false)
  	...
  	exports['dxLibary']:dxLibary_text('¿No tienes cuenta?  #4800bf¡Entonces registrate :D!', animations['button'][1][actionTypeLogin]/zoom, 645/zoom, 1123/zoom, 705/zoom, tocolor(255, 255, 255, 255), 1, 'default', 'center', 'center', false, false, false, true, false)
	 ...
	 exports['dxLibary']:dxLibary_text('¿Olvidaste tu contraseña?  ¡Entonces haz click aquí!', animations['button'][1][actionTypeLogin]/zoom + 1, 700/zoom + 1, 1123/zoom + 1, 705/zoom + 1, tocolor(0, 0, 0, 255), 1, 'default', 'center', 'center', false, false, false, true, false)
  	exports['dxLibary']:dxLibary_text('¿Olvidaste tu contraseña?  #4800bf¡Entonces haz click aquí!', animations['button'][1][actionTypeLogin]/zoom, 700/zoom, 1123/zoom, 705/zoom, tocolor(255, 255, 255, 255), 1, 'default', 'center', 'center', false, false, false, true, false)
	...
	exports['dxLibary']:dxLibary_text('PANEL DE LOGUEO', animations['button'][1][actionTypeLogin]/zoom + 1, 125/zoom + 1, 1123/zoom + 1, 705/zoom + 1, tocolor(0, 0, 0, 255), 2, 'default', 'center', 'center', false, false, false, true, false)
  	exports['dxLibary']:dxLibary_text('PANEL DE #4800bfLOGUEO', animations['button'][1][actionTypeLogin]/zoom, 125/zoom, 1123/zoom, 705/zoom, tocolor(255, 255, 255, 255), 2, 'default', 'center', 'center', false, false, false, true, false)
-- REGISTRARSE
    ...
    dxDrawImage((650 + x)/zoom, 190/zoom, 250/zoom, 250/zoom, images['puls'], 0, 0, 0, tocolor(72, 0, 191, a), false)
  	...
  	exports['dxLibary']:dxLibary_text('¿Ya tienes cuenta?  #4800bf¡Entonces logueate!', animations['button'][1][actionTypeRegister]/zoom, 750/zoom, 1123/zoom, 705/zoom, tocolor(255, 255, 255, 255), 1, 'default', 'center', 'center', false, false, false, true, false)
	...
	exports['dxLibary']:dxLibary_text('PANEL DE REGISTRO', animations['button'][1][actionTypeRegister]/zoom + 1, 125/zoom + 1, 1123/zoom + 1, 705/zoom + 1, tocolor(0, 0, 0, 255), 2, 'default', 'center', 'center', false, false, false, true, false)
  	exports['dxLibary']:dxLibary_text('PANEL DE #4800bfREGISTRO', animations['button'][1][actionTypeRegister]/zoom, 125/zoom, 1123/zoom, 705/zoom, tocolor(255, 255, 255, 255), 2, 'default', 'center', 'center', false, false, false, true, false)
    ...
    exports['dxLibary']:dxLibary_createButton('Restablecer contraseña', animations['button'][1][actionTypeContra]/zoom, 675/zoom, 324/zoom, 35/zoom, 3)
  	...
  	exports['dxLibary']:dxLibary_text('¿Quieres volver donde antes?  #4800bf¡Entonces haz click aquí!', animations['button'][1][actionTypeContra]/zoom, 750/zoom, 1123/zoom, 705/zoom, tocolor(255, 255, 255, 255), 1, 'default', 'center', 'center', false, false, false, true, false)
	...
	exports['dxLibary']:dxLibary_text('PANEL DE RESTABLECEDOR DE CONTRASEÑA', animations['button'][1][actionTypeRegister]/zoom + 1, 125/zoom + 1, 1123/zoom + 1, 705/zoom + 1, tocolor(0, 0, 0, 255), 2, 'default', 'center', 'center', false, false, false, true, false)
  	exports['dxLibary']:dxLibary_text('PANEL DE RESTABLECEDOR DE #4800bfCONTRASEÑA', animations['button'][1][actionTypeRegister]/zoom, 125/zoom, 1123/zoom, 705/zoom, tocolor(255, 255, 255, 255), 2, 'default', 'center', 'center', false, false, false, true, false)

    local x = math.sin(getTickCount()/500)*1
  	dxDrawImage((644 + x)/zoom, 220/zoom, 632/zoom, 194/zoom, images['logo'])

    local a = (math.sqrt(getSoundFFTData(sound, 2048, 2)[1])*256) or 150
    dxDrawImage((650 + x)/zoom, 190/zoom, 250/zoom, 250/zoom, images['puls'], 0, 0, 0, tocolor(87, 35, 100, a), false)
