...
function showLogin(serialRegistered)
	...
	lp.register.button = dxCreateButton((sX/2 - (425*x)/2 - 280*x) + (250*x)/2 - (100*x)/2,( sY/2 - (250*y)/2 ) + (200*y),120*x,40*y,"Registrar",tocolor(0,0,0,255))
	...
	addEventHandler("onClientRender",root,drawEdvis)
...
function()
	...
	removeEventHandler("onClientRender",root,drawEdvis)
...
function drawLogin()
	dxDrawImage(x*0, y*0, x*1366, y*768, "img/fondo.png")
	
	dxDrawImage(x*120, y*55, x*100, y*100, "img/logo.png", getTickCount() / 20% 360)
	dxDrawImage(x*1170, y*55, x*100, y*100, "img/logo.png", getTickCount() / 20% 360)
	
	
	dxDrawText2("ExoticRP - Fort Carson",sX/2 - (405*x)/2,0,400*x,160*y,tocolor(0,0,0, math.abs(math.sin(getTickCount()/700))*255), 3*fontsize,"arial","center","bottom")
	dxDrawText2("ExoticRP - Fort Carson",sX/2 - (400*x)/2,0,400*x,160*y,tocolor(255,255,255, math.abs(math.sin(getTickCount()/700))*255), 3*fontsize,"arial","center","bottom")
	
	 --dxDrawImage(x*461, y*153, x*440, y*491, "images/bakcground.png", 0, 0, 0, tocolor(255, 255, 255, 255), false)
...
function drawRegister()
	...
	dxDrawText2("¿No tienes cuenta? ¡Crea una!",(sX/2 - (405*x)/2) - 280*x,0,250*x,250*y,tocolor(0,0,0,255),1.5*fontsize,"arial","center","bottom")
...
function drawEdvis()
	...
	dxDrawText2("Links",(sX/2 - (395*x)/2) + 430*x,0,250*x,250*y,tocolor(0,0,0,255),3*fontsize,"arial","center","bottom")
	dxDrawText2("Links",(sX/2 - (400*x)/2) + 430*x,0,250*x,250*y,tocolor(255,255,255,255),3*fontsize,"arial","center","bottom")
	...
	dxDrawText2("En desarrollo acutalmente...",(sX/2 - (235*x)/2) + 350*x,0,250*x,350*y,tocolor(math.abs(math.sin(getTickCount()/700))*255,255,255,255),1.75*fontsize,"arial","center","bottom")
	dxDrawText2("En desarrollo acutalmente...",(sX/2 - (235*x)/2) + 350*x,0,250*x,375*y,tocolor(255,math.abs(math.sin(getTickCount()/700))*255,255,255),1.75*fontsize,"arial","center","bottom")
	dxDrawText2("En desarrollo acutalmente...",(sX/2 - (235*x)/2) + 350*x,0,250*x,400*y,tocolor(255,255,math.abs(math.sin(getTickCount()/700))*255,255),1.75*fontsize,"arial","center","bottom")
