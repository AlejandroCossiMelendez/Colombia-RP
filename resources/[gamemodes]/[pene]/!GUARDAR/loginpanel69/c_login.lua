...
-- REGISTRARSE
    ...
    dxDrawImage((650 + x)/zoom, 190/zoom, 250/zoom, 250/zoom, images['puls'], 0, 0, 0, tocolor(0, 255, 0, a), false)
  	...
  	exports['dxLibary']:dxLibary_text('¿Ya tienes cuenta?  #00ff00¡Entonces logueate!', animations['button'][1][actionTypeRegister]/zoom, 750/zoom, 1123/zoom, 705/zoom, tocolor(255, 255, 255, 255), 1, 'default', 'center', 'center', false, false, false, true, false)
	...
	exports['dxLibary']:dxLibary_text('PANEL DE REGISTRO', animations['button'][1][actionTypeRegister]/zoom + 1, 125/zoom + 1, 1123/zoom + 1, 705/zoom + 1, tocolor(0, 0, 0, 255), 2, 'default', 'center', 'center', false, false, false, true, false)
  	exports['dxLibary']:dxLibary_text('PANEL DE #00FF00REGISTRO', animations['button'][1][actionTypeRegister]/zoom, 125/zoom, 1123/zoom, 705/zoom, tocolor(255, 255, 255, 255), 2, 'default', 'center', 'center', false, false, false, true, false)
    ...
    exports['dxLibary']:dxLibary_createButton('Restablecer contraseña', animations['button'][1][actionTypeContra]/zoom, 675/zoom, 324/zoom, 35/zoom, 3)
  	...
  	exports['dxLibary']:dxLibary_text('¿Quieres volver donde antes?  #00ff00¡Entonces haz click aquí!', animations['button'][1][actionTypeContra]/zoom, 750/zoom, 1123/zoom, 705/zoom, tocolor(255, 255, 255, 255), 1, 'default', 'center', 'center', false, false, false, true, false)
	...
	exports['dxLibary']:dxLibary_text('PANEL DE RESTABLECEDOR DE CONTRASEÑA', animations['button'][1][actionTypeRegister]/zoom + 1, 125/zoom + 1, 1123/zoom + 1, 705/zoom + 1, tocolor(0, 0, 0, 255), 2, 'default', 'center', 'center', false, false, false, true, false)
  	exports['dxLibary']:dxLibary_text('PANEL DE RESTABLECEDOR DE #00FF00CONTRASEÑA', animations['button'][1][actionTypeRegister]/zoom, 125/zoom, 1123/zoom, 705/zoom, tocolor(255, 255, 255, 255), 2, 'default', 'center', 'center', false, false, false, true, false)
