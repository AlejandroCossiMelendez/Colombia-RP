			...
			if other then
				...
				if tonumber(s.casadocon) == 0 then
					...
					if exports.players:takeMoney(thePlayer, 15000 ) then
						...
						outputChatBox("[Español] [FM] Reportero dice: Tenemos noticias ciudadanos de San Fierro!", root, 62, 184, 255)
						outputChatBox("[Español] [FM] Reportero dice: Tenemos un nuevo matrimonio! , se ha casado "..getPlayerName(thePlayer):gsub("_", " ").." con "..getPlayerName(other):gsub("_", " ").." Felicidades", root, 62, 184, 255)
