...
shop_configurations =
{
    ...
    ilegal =
    {
		...
		{ itemID = 31, itemValue = 31, itemValue2 = 1, name = "M4", description = "¿Quieres defenderte tio?", price = 300 },
	}, 
	armas =
    {
        name = "Armas",
        skin = 21,             
		nivel = 0,
	    { itemID = 29, itemValue = 22, itemValue2 = 1, name = "Colt 45", description = "Creo que este artículo no necesita una descripción.", price = 90000 },
		{ itemID = 29, itemValue = 23, itemValue2 = 1, name = "Colt 45 (Silenced)", description = "Creo que este artículo no necesita una descripción.", price = 95000 },
		{ itemID = 29, itemValue = 25, itemValue2 = 1, name = "Escopeta", description = "Creo que este artículo no necesita una descripción.", price = 200000 },
		{ itemID = 29, itemValue = 28, itemValue2 = 1, name = "Uzi", description = "Creo que este artículo no necesita una descripción.", price = 250000 },
		{ itemID = 29, itemValue = 30, itemValue2 = 1, name = "AK-47", description = "Creo que este artículo no necesita una descripción.", price = 700000 },
		{ itemID = 43, itemValue = 22, itemValue2 = 1, name = "Cargador Colt 45", description = "Un arma sin cargador, es como no tener nada.", price = 500 },
		{ itemID = 43, itemValue = 23, itemValue2 = 1, name = "Cargador Colt 45 (Silenced)", description = "Un arma sin cargador, es como no tener nada.", price = 500 },
		{ itemID = 43, itemValue = 25, itemValue2 = 1, name = "Cargador Escopeta", description = "Un arma sin cargador, es como no tener nada.", price = 1000 },
		{ itemID = 43, itemValue = 28, itemValue2 = 1, name = "Cargador Uzi", description = "Un arma sin cargador, es como no tener nada.", price = 3000 },
		{ itemID = 43, itemValue = 30, itemValue2 = 1, name = "Cargador AK-47", description = "Un arma sin cargador, es como no tener nada.", price = 5000 },
	},
	armas_evento =
    {
        name = "Armas Evento",
