...
function todo(player)
	...
	outputChatBox("Has aceptado las condiciones de uso de Vendetta RolePlay. ¡Disfruta del servidor!", player, 0, 255, 0)
	...
	if sql and sql.nuevo and sql.nuevo == 1 then
			outputChatBox("Bienvenido por primera vez a Vendetta RolePlay.", player, 0, 255, 0)
