--[[
Copyright (C) 2019 Vendetta RolePlay
...
function showCondiciones(version, texto)
        ...
        ventana = guiCreateWindow(0.31, 0.18, 0.37, 0.70, "Condiciones del servicio.  Vendetta RolePlay. Versión "..tostring(version), true)
