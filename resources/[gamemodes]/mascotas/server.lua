...
function comprarMascota(player, cmd, tipo, nombre)
	if not tipo or not nombre then
		...
		if tonumber(sql.cuenta) == 0 then
			if getElementDimension(player) ~= 649 then
...
addCommandHandler("comprarmascota", comprarMascota) Si se habilita el sistema de mascotas, reajustar el ID del interior de tienda (649)
...
function cargarmascotasperrera()
	...
	setElementInterior(ped88,6)
	setElementDimension(ped88,649)
	...
	setElementInterior(ped89,6)
	setElementDimension(ped89,649)
	...
	setElementInterior(ped243,6)
	setElementDimension(ped243,649)
	...
	setElementInterior(ped244,6)
	setElementDimension(ped244,649)
	...
	setElementInterior(ped252,6)
	setElementDimension(ped252,649)
