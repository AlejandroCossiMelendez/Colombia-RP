local markerIdiomas = createMarker(-2240.1611328125, 128.1875, 1035.4210205078, "cylinder", 1.5, 102, 204, 255, 127) 

setElementInterior(markerIdiomas, 10)
setElementDimension(markerIdiomas, 820)
