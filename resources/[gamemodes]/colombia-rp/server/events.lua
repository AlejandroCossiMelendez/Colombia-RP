...
outputServerLog("[EVENTS] Eventos de pólvora/C4 registrados: polvora:clickNPC, polvora:comprarItem, polvora:usarItem, polvora:colocarC4, polvora:c4Explotado, polvora:notificarExplosion, polvora:abrirPanel, polvora:activarEfecto")
