...
outputServerLog("[EVENTS] Eventos del panel de administración registrados: admin:revivePlayer, admin:teleportToPlayer, admin:toggleInvisibility, admin:healPlayer, admin:giveMoney, admin:getCoords, admin:reviveResponse, admin:teleportResponse, admin:healResponse, admin:giveMoneyResponse, admin:invisibilityUpdate")
