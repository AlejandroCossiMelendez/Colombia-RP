...
outputServerLog("[EVENTS] Eventos de llamadas registrados: phone:makeCall, phone:answerCall, phone:hangup, phone:toggleSpeaker, phone:incomingCall, phone:callAnswered, phone:callEnded, phone:callRinging, phone:callFailed")
-- Eventos de JBL
