...
outputServerLog("[EVENTS] Eventos del panel de administración registrados: admin:revivePlayer, admin:teleportToPlayer, admin:toggleInvisibility, admin:healPlayer, admin:getCoords, admin:reviveResponse, admin:teleportResponse, admin:healResponse, admin:invisibilityUpdate")
