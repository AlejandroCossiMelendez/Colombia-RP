...
function updateInventory( )
	...
	if t then                                                                                 
		for k, v in ipairs( t ) do
			...
			local image = (v.item == 5551555 and ':ropas/icons/'..categoria[TAB[3]]..'.png') or (v.item == 5552555 and ':toys/files/'..(TAB[2])..'.png') or exports.items:getImage( v.item, v.value, nItem )
