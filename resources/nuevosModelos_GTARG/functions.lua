...
local dataNames = {
	['object'] = getDataNameFromType('object'),
	['vehicle'] = getDataNameFromType('vehicle'),
	['ped'] = getDataNameFromType('ped'),
	['player'] = getDataNameFromType('player'),
	['pickup'] = getDataNameFromType('pickup'),
}
local baseDataName = getBaseModelDataName()
