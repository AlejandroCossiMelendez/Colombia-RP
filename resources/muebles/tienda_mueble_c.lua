...
local but = {}
local lbl = {}
local categoria = { [0] = "Armarios", [1] = "Camas", [2] = "Sofás", [3] = "Sillas y Sillones", [4] = "TVs y Estantes", [5] = "Otros Muebles", [6] = "Deporte", [7] = "Mis Muebles Comprados", [8] = "Cocina" }
local tipoG = 1

function tiendaMuebleGUI()
	window[1] = guiCreateWindow(0.01,0.4,0.35,0.6,"Tienda de muebles",true)
