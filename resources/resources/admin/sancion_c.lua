...
function GUISancionar(nombrep)
	if nombrep then
        ...
        guiComboBoxAddItem(cboxSanciones, "#1 DM / TTO")
		guiComboBoxAddItem(cboxSanciones, "#2 PG / Forzar Rol")
		guiComboBoxAddItem(cboxSanciones, "#3 MG / MG2")
		guiComboBoxAddItem(cboxSanciones, "#4 RK / SK / CK / TK")
		guiComboBoxAddItem(cboxSanciones, "#5 Flamming / IOOC / Mentir o ignorar Staff/AIOOC")
		guiComboBoxAddItem(cboxSanciones, "#6 IHQ / AHQ / ICN / RSL")
		guiComboBoxAddItem(cboxSanciones, "#7 Troll / BD / CJ / VDM")
		guiComboBoxAddItem(cboxSanciones, "#8 Flood / SPAM / PI")
		guiComboBoxAddItem(cboxSanciones, "#9 BA / AA2 / LA")
		guiComboBoxAddItem(cboxSanciones, "#10 Multicuentas")
		guiComboBoxAddItem(cboxSanciones, "#11 NRA / NRH / NRE / NRC")
		guiComboBoxAddItem(cboxSanciones, "#12 Evasión de Rol / NA")
		guiComboBoxAddItem(cboxSanciones, "#13 Reporte Innecesario (Reportante)")
		guiComboBoxAddItem(cboxSanciones, "#14 NIP / NVVPJ / ZZ")
		guiComboBoxAddItem(cboxSanciones, "#15 MUD / MUA / MUT / AD")
		guiComboBoxAddItem(cboxSanciones, "#16 BJ / CA")
		guiComboBoxAddItem(cboxSanciones, "#17 MUDVT / AVP")
