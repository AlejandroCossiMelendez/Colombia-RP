function mensajePolicial(source, commandName, ...)
    ...
    if exports.factions:isPlayerInFaction(source, 7) then
        if mensajeAnuncio ~= "" and mensajeAnuncio ~= " " then
            for k, v in ipairs(getElementsByType("player")) do
                outputChatBox("#FFFFFF[ LEGAL ]  #FFFFFFAnuncios [#F4E71AMercado Libre#FFFFFF] : #FFFFFF"..mensajeAnuncio, v, 255, 255, 255, true)
            end
        else
...
addCommandHandler("mlb", mensajePolicial)