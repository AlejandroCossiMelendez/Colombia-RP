function mensajePolicial(source, commandName, ...)
    ...
    if exports.factions:isPlayerInFaction(source, 43) then
        if mensajeAnuncio ~= "" and mensajeAnuncio ~= " " then
            for k, v in ipairs(getElementsByType("player")) do
                outputChatBox("#FFFFFF[ LEGAL ] #FFFFFF[#FF0000DIAN#FFFFFF]: #FFFFFF"..mensajeAnuncio, v, 255, 255, 255, true)
            end
        else
...
addCommandHandler("dian", mensajePolicial)