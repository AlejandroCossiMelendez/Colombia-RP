...
function onStart()
    fuente = dxCreateFont("RobotoL.ttf", 10, false, "antialiased")
end
							...
							if not (collision) or aimsSniper() or (reconx) then
								...
								if (sx) and (sy) then
									...
									if (sx) and (sy) and oldsy then
										...
										if badge then
											sy = sy - dxGetFontHeight(scale, fuente) * scale + 2.0
										end
										...
										if getElementData(player, "taseado") == true then
											dxDrawText(tostring(yo2), sx-offset+2, sy+2, (sx-offset)+130 / distance, sy+50 / distance, tocolor(0, 0, 0, 220), scale*0.70, fuente, "center", "center", false, false, false)
											dxDrawText(tostring(yo2), sx-offset, sy, (sx-offset)+130 / distance, sy+50 / distance, tocolor( 84, 255, 255 , 220), scale*0.70, fuente, "center", "center", false, false, false)
											dxDrawText(name, sx-offset+2, sy+2, (sx-offset)+130 / distance, sy+20 / distance, tocolor(0, 0, 0, 220), scale, fuente, "center", "center", false, false, false)
											dxDrawText(name, sx-offset, sy, (sx-offset)+130 / distance, sy+17 / distance, tocolor(r, g, b, 220), scale, fuente, "center", "center", false, false, false)
											dxDrawText("[TASEADO]", sx-offset+2, sy+2, (sx-offset)+130 / distance, sy-15 / distance, tocolor(255, 155, 0, 220), scale, fuente, "center", "center", false, false, false)
										elseif getElementData(player, "esposado") == true then
											dxDrawText(tostring(yo2), sx-offset+2, sy+2, (sx-offset)+130 / distance, sy+50 / distance, tocolor(0, 0, 0, 220), scale*0.70, fuente, "center", "center", false, false, false)
											dxDrawText(tostring(yo2), sx-offset, sy, (sx-offset)+130 / distance, sy+50 / distance, tocolor( 84, 255, 255 , 220), scale*0.70, fuente, "center", "center", false, false, false)
											dxDrawText(name, sx-offset+2, sy+2, (sx-offset)+130 / distance, sy+20 / distance, tocolor(0, 0, 0, 220), scale, fuente, "center", "center", false, false, false)
											dxDrawText(name, sx-offset, sy, (sx-offset)+130 / distance, sy+17 / distance, tocolor(r, g, b, 220), scale, fuente, "center", "center", false, false, false)
											dxDrawText("[ESPOSADO]", sx-offset+2, sy+2, (sx-offset)+130 / distance, sy-15 / distance, tocolor(255, 155, 0, 220), scale, fuente, "center", "center", false, false, false)
										elseif getElementHealth(player) <= 30 then
											dxDrawText(tostring(yo2), sx-offset+2, sy+2, (sx-offset)+130 / distance, sy+50 / distance, tocolor(0, 0, 0, 220), scale*0.70, fuente, "center", "center", false, false, false)
											dxDrawText(tostring(yo2), sx-offset, sy, (sx-offset)+130 / distance, sy+50 / distance, tocolor( 84, 255, 255 , 220), scale*0.70, fuente, "center", "center", false, false, false)
											dxDrawText(name, sx-offset+2, sy+2, (sx-offset)+130 / distance, sy+20 / distance, tocolor(0, 0, 0, 220), scale, fuente, "center", "center", false, false, false)
											dxDrawText(name, sx-offset, sy, (sx-offset)+130 / distance, sy+17 / distance, tocolor(r, g, b, 220), scale, fuente, "center", "center", false, false, false)
											dxDrawText("[HERIDO]", sx-offset+2, sy+2, (sx-offset)+130 / distance, sy-15 / distance, tocolor(255, 155, 0, 220), scale, fuente, "center", "center", false, false, false)
										else
											dxDrawText(tostring(yo2), sx-offset+2, sy+2, (sx-offset)+130 / distance, sy+50 / distance, tocolor(0, 0, 0, 220), scale*0.70, fuente, "center", "center", false, false, false)
											dxDrawText(tostring(yo2), sx-offset, sy, (sx-offset)+130 / distance, sy+50 / distance, tocolor( 84, 255, 255 , 220), scale*0.70, fuente, "center", "center", false, false, false)
											dxDrawText(name, sx-offset+2, sy+2, (sx-offset)+130 / distance, sy+20 / distance, tocolor(0, 0, 0, 220), scale, fuente, "center", "center", false, false, false)
								...
								if (sx) and (sy) then
									...
									if (oldsy) and (id) then
										if (id<100 and id>9) then -- 2 digits
											...
											dxDrawText(tostring(id), sx-offset-22.5, oldsy, (sx-offset)+26 / distance, sy+20 / distance, tocolor(255, 255, 255, 220), scale, fuente, "center", "center", false, false, false)
										elseif (id<=9) then -- 1 digit
											dxDrawRectangle(sx-offset-5, oldsy, 20 / distance, 20 / distance, tocolor(0, 0, 0, 100), false)
											dxDrawText(tostring(id), sx-offset-12.5, oldsy, (sx-offset)+26 / distance, sy+20 / distance, tocolor(255, 255, 255, 220), scale, fuente, "center", "center", false, false, false)
