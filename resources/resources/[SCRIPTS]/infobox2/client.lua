...
local font0_arlrdbd =  dxCreateFont("img/arlrdbd.ttf", 10, false)
...
-- DESIGN -- 
notifications.padding = 11
notifications.offset = 450 * relativeScale
notifications.offsetWidth = 5
-- TEXT
notifications.font = font0_arlrdbd
notifications.fontScale = 1.08 * relativeFontScale
...
notifications.timeMaxToShow = 6000 -- mseconds
