...
local sx, sy = (screen[1] / 1280), (screen[2] / 768)
dxDraw = {}
functions = {}
local TEST = false

local font = dxCreateFont("utils/font.ttf", sx*13)
...
function dxDraw:Button(buttonType, text, x, y, rx, ry, color, radius)
    ...
    if buttonType == 'Rectangle' then
        ...
        dxDraw:Text( text, x, y, rx + x, ry + y, tocolor( 255, 255, 255 ), 1.2, font 'center', 'center', true, true )
