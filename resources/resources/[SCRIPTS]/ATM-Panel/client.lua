...
addEventHandler("onClientRender", root,
    function()
        ...
        DxRoundedRectangle( sx*300, sy*150, sx*680, sy*420, tocolor(255, 255, 255, 0 ), 10 )
        ...
        if isMouseInPosition( sx*321, sy*293, sx*111, sy*31 ) then
            DxRoundedRectangle( sx*321, sy*293, sx*111, sy*31, tocolor( 58, 130, 255, 230 ), 5 )
        end

        if isMouseInPosition( sx*321, sy*333, sx*111, sy*31 ) then
            DxRoundedRectangle( sx*321, sy*333, sx*111, sy*31, tocolor( 58, 130, 255, 230 ), 5 )
        end

        if isMouseInPosition( sx*321, sy*374, sx*111, sy*31 ) then
            DxRoundedRectangle( sx*321, sy*374, sx*111, sy*31, tocolor( 58, 130, 255, 230 ), 5 )
        end

        if isMouseInPosition( sx*321, sy*416, sx*111, sy*31 ) then
            DxRoundedRectangle( sx*321, sy*416, sx*111, sy*31, tocolor( 58, 130, 255, 230 ), 5 )
        end
        ...
        dxDrawText( "Transferencia",sx*352, sy*417, sx*432, sy*449, tocolor(255, 255, 255, dxAlpha), 1.00, dxfont0_medium, "center", "center", false, false, false, false, false)
        dxDrawText( "Salir", sx*352, sy*514, sx*432, sy*545, iconColor_, 1.00, dxfont0_medium, "center", "center", false, false, false, false, false)
        
        dxDrawText( "General",sx*490, sy*177, sx*682, sy*225, tocolor(255, 255, 255, dxAlpha), 1.00, dxfont1_bold, "left", "center", false, false, false, false, false)
        ...
        dxDrawText( "Cartera: ".. playerMoney .." $", sx*711, sy*201, sx*882, sy*225, tocolor(0, 255, 15, dxAlpha), 1.00, dxfont2_bold, "right", "center", false, false, false, false, false)
        dxDrawText( "Bienvenido ".. playerName:gsub( "_", " " ), sx*490, sy*265, sx*775, sy*314, tocolor(255, 255, 255, dxAlpha), 1.00, dxfont1_bold, "left", "center", false, false, false, false, false)
        dxDrawText( "Bancolombia ATM", sx*751, sy*545, sx*980, sy*570, tocolor(255, 255, 255, dxAlpha), 1.00, dxfont0_medium, "center", "center", false, false, false, false, false)
        ...
        dxDrawText( "SALDO MAXIMO: 4MIL MILLONES", sx*490, sy*409, sx*825, sy*464, tocolor(255, 255, 255, dxAlpha), 1.00, dxfont3_semi_bold, "center", "center", false, false, false, false, false)
        ...
        if deposito_dinero then
            ...
            dxDrawText( "DEPOSITAR", sx*574, 396, sx*705, sy*445, tocolor(255, 255, 255, 255), 1.00, dxfont1_medium, "center", "center", false, false, false, false, false)

            if isCursorOverText( sx*758, sy*274, sx*790, sy*306 ) then
                closeFx = tocolor( 58, 130, 255, 255 )
            else 
                closeFx = tocolor( 255, 255, 255, 255 )
            end

            if isMouseInPosition( sx*575, sy*395, sx*130, sy*35 ) then
                deposito_dineroColor = tocolor(58, 130, 255, 255)
            else
        ...
        if retiro_dinero then
           ...
           DxRoundedRectangle( sx*490, sy*275, sx*300, sy*170, tocolor(14, 14, 24, 255), 8 )
            ...
            DxRoundedRectangle( sx*575, sy*395, sx*130, sy*35, deposito_dineroColor, 5 )
            dxDrawText( "RETIRAR", sx*574, 396, sx*705, sy*445, tocolor(255, 255, 255, 255), 1.00, dxfont1_medium, "center", "center", false, false, false, false, false)
