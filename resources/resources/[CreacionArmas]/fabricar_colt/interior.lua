----------------------------------------------------------------------------------------------------------------------------------------
--local enter = createMarker(2357.236328125, -648.44921875, 128.0546875 + 0.75, "arrow", 1.25, 255, 255, 255, 100)
--local exit = createMarker(2357.236328125, -648.44921875, 128.0546875 + 0.75, "arrow", 1.25, 255, 255, 255, 100)
--local obj = createObject(2533.502, -1666.769, 15.164, 0, 0, 270)
local marker = createMarker(2541.4990234375, -1283.9228515625, 1044.125 -1, "cylinder", 1.50, 255, 0, 0, 100)
local int = 2
local dim = 1980
...
local material, slot, v = exports.items:has(playerSource, 58)
local material2, slot2, v2 = exports.items:has(playerSource, 59)
local material3, slot3, v3 = exports.items:has(playerSource, 60)
if material and material2 and material3 then
	...
	local x2, y2, z2 = getElementPosition(marker)
		if getDistanceBetweenPoints3D(x, y, z, x2, y2, z2) <= 3 then
			...
			setTimer(function()
                ...
                giveWeapon(playerSource, 22)
				exports.infobox:addNotification(playerSource, "Has fabricado una Colt-45", "success")
				exports.chat:me(playerSource, "ha fabricado un Colt-45.")
	...
	exports.infobox:addNotification(playerSource, "No tienes los materiales necesario para fabricar una Colt-45", "error")
end
else
