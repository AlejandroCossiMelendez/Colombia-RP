...
function renderTec9()
	...
	dxDrawText("1 -   3 Cautiles\n2 -   1 Pieza Cargador AK-47", screenW * 0.4050, screenH * 0.4900, screenW * 0.5988, screenH * 0.6706, tocolor(255, 255, 255, 255), 0.80, font2, "left", "center", false, false, false, false, false)
	...
	dxDrawImage(screenW * 0.4729, screenH * 0.3919, screenW * 0.0549, screenH * 0.0977, "ak47.png", 0, 0, 0, tocolor(255, 255, 255, 255), false)
end
...
addEvent("ToggleAk47", true)
addEventHandler("ToggleAk47", resourceRoot, ToggleAk47)

----------------------------------------------------------------------------------------------------------------------------------------
-- FUNCIÓN PARA DETECTAR CLICS EN EL PANEL
----------------------------------------------------------------------------------------------------------------------------------------
function onak47Click(button, state)
	if button == "left" and state == "down" then
		if isPanelVisible then
			...
			elseif isCursorOnElement(screenW * 0.4580, screenH * 0.6270, screenW * 0.0871, screenH * 0.0391) then
				triggerServerEvent("fabricarAk47", resourceRoot, localPlayer)
				ToggleAk47()
			end
		end
	end
end
addEventHandler("onClientClick", root, onak47Click)
