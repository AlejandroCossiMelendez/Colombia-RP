...
local function createPedBasurero( )
	...
	PedBasurero = createPed( 16, 162.3212890625, -26.291015625, 1.578125, 0, false )
	setElementData( PedBasurero, "npcname", "Tino Svenson" )
	setElementRotation(PedBasurero,0,0,-65)
...
function desbugBot(player)
	setElementPosition(PedBasurero, -162.3212890625, -26.291015625, 1.578125)
end
