...
function darPresupuesto (player, cmd, facID, cantidad)
	...
	if facID and cantidad then
		if exports.factions:takeFactionPresupuesto(5, tonumber(cantidad)) == true then
			...
			exports.logsic:addLogMessage("gobierno", getPlayerName(player).." dió a la empresa "..tostring(exports.factions:getFactionName(tonumber(facID))).." $"..tostring(cantidad))
		else
...
function takePresupuesto (player, cmd, facID, cantidad)
	...
	if facID and cantidad then
		if exports.factions:takeFactionPresupuesto(tonumber(facID), tonumber(cantidad)) == true then
			...
			exports.logsic:addLogMessage("gobierno", getPlayerName(player).." quitó a la empresa "..tostring(exports.factions:getFactionName(tonumber(facID))).." $"..tostring(cantidad))
		else
