...
function drawCustomHUD()
    ...
    local hungerColor = hungerPercent > 30 and colors.hunger or colors.health  -- Rojo si está muy bajo
    ...
    local thirstColor = thirstPercent > 30 and colors.thirst or colors.health  -- Rojo si está muy bajo
    ...
    if isUnderwater then
        ...
        oxygen = math.max(0, math.min(100, (pedOxygen / 1000) * 100))  -- Convertir a porcentaje (0-1000 en MTA)
        
        local oxygenCardHeight = 60
        local oxygenPercent = math.max(0, math.min(100, oxygen))
        local oxygenColor = oxygenPercent > 30 and colors.oxygen or colors.health  -- Rojo si está muy bajo
