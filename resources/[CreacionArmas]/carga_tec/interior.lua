local marker = createMarker(4305.060546875, 217.4267578125, 8.7974739074707 -1, "cylinder", 1.10, 255, 130, 0, 100)
local int = 4
local dim = 427
...
if material and material2 then
	...
	local x2, y2, z2 = getElementPosition(marker)
		if getDistanceBetweenPoints3D(x, y, z, x2, y2, z2) <= 3 then
			...
			setTimer(function()
			    ...
			    exports.items:give(playerSource, 43, 32)
			    exports.items:give(playerSource, 43, 32)
				exports.infobox:addNotification(playerSource, "Has fabricado cargadores de Tec-9", "success")
	...
	exports.infobox:addNotification(playerSource, "No tienes los materiales necesarios para fabricar cargadores de Tec-9", "error")
end
else
