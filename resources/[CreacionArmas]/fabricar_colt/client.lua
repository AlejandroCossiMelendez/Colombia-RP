...
function render()
	...
	dxDrawText("1 -   Cuerpo de Colt-45\n2 -   Cargador de Colt-45\n3 -   Cañon de Colt-45", screenW * 0.4050, screenH * 0.4900, screenW * 0.5988, screenH * 0.6706, tocolor(255, 255, 255, 255), 0.80, font2, "left", "center", false, false, false, false, false)
	...
	dxDrawText("    FABRICAR COLT-45", screenW * 0.3946, screenH * 0.3164, screenW * 0.5717, screenH * 0.3620, tocolor(255, 255, 255, 255), 1.00, font2, "left", "center", false, false, false, false, false)
