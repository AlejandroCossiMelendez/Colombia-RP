local marker = createMarker(4304.8916015625, 222.12890625, 8.8161087036133 -1, "cylinder", 1.10, 255, 130, 0, 100)
local int = 4
local dim = 427
...
if material and material2 then
	...
	local x2, y2, z2 = getElementPosition(marker)
		if getDistanceBetweenPoints3D(x, y, z, x2, y2, z2) <= 3 then
			...
			setTimer(function()
			    ...
			    exports.items:give(playerSource, 43, 30)
			    exports.items:give(playerSource, 43, 30)
				exports.infobox:addNotification(playerSource, "Has fabricado cargadores de AK-47", "success")
	...
	exports.infobox:addNotification(playerSource, "No tienes los materiales necesarios para fabricar cargadores de AK-47", "error")
end
else
