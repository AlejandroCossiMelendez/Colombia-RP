...
local CHIVA_SEATS_CONFIG = {
    ...
    {seat = 2, name = "Izquierda - Asiento 1", side = "left", offsetX = -9.85, offsetY = -30.50, offsetZ = 1.5},  -- Más atrás
    {seat = 3, name = "Izquierda - Asiento 2", side = "left", offsetX = -8.49, offsetY = -30.40, offsetZ = 1.5},
    {seat = 4, name = "Izquierda - Asiento 3", side = "left", offsetX = -7.55, offsetY = -30.40, offsetZ = 1.5},
    {seat = 5, name = "Izquierda - Asiento 4", side = "left", offsetX = -6.74, offsetY = -30.45, offsetZ = 1.5},  -- Más adelante
