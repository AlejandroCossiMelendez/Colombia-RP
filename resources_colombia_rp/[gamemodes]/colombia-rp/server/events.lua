...
addEvent("vehicle:keyCheckResult", true)
...
outputServerLog("[EVENTS] Eventos del panel de administración registrados: admin:revivePlayer, admin:teleportToPlayer, admin:bringPlayer, admin:toggleInvisibility, admin:healPlayer, admin:changeSkin, admin:giveMoney, admin:getCoords, admin:getItemsList, admin:giveItems, admin:reviveResponse, admin:teleportResponse, admin:healResponse, admin:changeSkinResponse, admin:giveMoneyResponse, admin:giveItemsResponse, admin:invisibilityUpdate")
